...
const steps = [
  {
    ...
    description: "Sign up on our platform by providing your basic information. Complete your profile so we can best match you with appropriate care.",
    icon: (
  ...
  },
  {
    ...
    description: "Select the type of mental health service you need. We offer various categories to address different aspects of mental wellbeing.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  },
  {
    step: "3",
    title: "Select Event",
    description: "Choose from available events and sessions that match your selected category. Each event provides details about what to expect.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  },
  {
    step: "4",
    title: "Review & Submit",
    description: "Review your category and service selection, then submit your request. There's no need to pick a date and time — our team will arrange the schedule for you.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  },
  {
    ...
    description: "Submit your booking request. You will receive a confirmation that your request has been received and is being reviewed.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  },
  {
    ...
    description: "Within 24-48 hours, we'll email you a proposed schedule. Review it and confirm, and your appointment will be locked in.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  },
  {
    ...
    description: "Once confirmed, attend your appointment at the scheduled time. Your mental health journey begins here.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  return (
    <>
      ...
      <PublicHero
        ...
        subtitle="HELP IS ON THE WAY creates a community-based mental health first response network, leveraging youth leaders, student councils, SK officials, and volunteers to provide direct mental health support, peer support, practical PFA, and linkages to crisis hotlines or community support when necessary. We want to champion the power of peer support and community care to ensure that no one feels alone in their mental health struggles. Through conversation, connection, and compassion, we bring bayanihan into mental wellness."
      >
        <HeroActions />
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-800 via-primary to-primary-700 py-20 text-white">
        ...
        <div className="container-page relative text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/40 bg-white/10 px-6 py-3 text-base font-semibold text-white backdrop-blur-sm transition-all duration-200 hover:bg-white/20"
            >
              Sign Up
            </Link>
            <Link
